...
<body>
<h1>Наша Любовь это реальность, есть свет или нет она будет жить </h1>
...
<script>
  ...
  function myTimer() {
    ...
    if (LEDStatus == 1) {
      document.getElementById("ledstatus").innerHTML = "Юля это красный день ";
    }
    if (LEDStatus == 0) {
      document.getElementById("ledstatus").innerHTML = "Дима любит и в тишине";
    }
    if (LEDStatus == "") {
      document.getElementById("ledstatus").innerHTML = "Время идет и я иду за тобою";
    }
  }
</script>  
